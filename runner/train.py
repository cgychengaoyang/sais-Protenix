...
from configs.configs_data_rna import data_configs_rna
...
def main():
    ...
    for k, v in zip(args[::2], args[1::2]):
        custom_args[k.replace('--', '')] = v
    if "custom_rna_data" in custom_args and custom_args['custom_rna_data'] == False:
        configs = {**configs_base, **{"data": data_configs}}
    else:
        configs = {**configs_base, **{"data": data_configs_rna}}
